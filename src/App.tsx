...
import ReactUniversalState from './react-universal-state/ReactUniversalState'
  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <Link to="/react-universal-state">React Universal State</Link>
        </li>
      </ul>
    </div>
  )
    ...
    <div>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="react-universal-state" element={<ReactUniversalState />} />
        </Routes>
      </BrowserRouter>
    </div>
  )
